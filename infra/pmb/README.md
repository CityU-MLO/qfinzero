...
# 2. Start the server (requires UPQ on port 19703)
python main.py
...
Server will listen on **http://127.0.0.1:19701**
...
- REST API at http://127.0.0.1:19703
...
```bash
curl -X POST http://127.0.0.1:19701/v1/sessions/sess_xyz/step \
  -H 'Content-Type: application/json' \
  -d '{"step": 1}'
```
...
```bash
curl http://127.0.0.1:19701/v1/sessions/sess_xyz/summary
```
...
export PMB_PORT=19701
export PMB_UPQ_BASE_URL=http://127.0.0.1:19703
...
python main.py
# or with reload:
uvicorn main:app --host 127.0.0.1 --port 19701 --reload
```
