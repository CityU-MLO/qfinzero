...
def implied_volatility(option_price, S, K, expiry_date, current_date, r, option_type="call"):
...
if __name__ == "__main__":
    ...
    iv = implied_volatility(option_price, S, K, expiry_date, current_date, r, option_type)
