...
def train_lasso_factor_combination(
    ...
    **kwargs
    ...
    try:
        ...
        if non_zero == 0:
            print("[LASSO Fixed] ⚠️  LASSO produced all zero weights - switching to Ridge Regression...")
        ...
        print(f"[LASSO Fixed] R2: {r2:.4f}, MSE: {mse:.6f}, Non-zero: {non_zero}/{len(weights)}")
