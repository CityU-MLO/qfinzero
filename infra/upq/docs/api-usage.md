...
```bash
curl "http://127.0.0.1:23333/stock?tickers=AAPL&start=2025-01-06T09:30:00&end=2025-01-06T16:00:00&fields=ticker,window_start,close,volume"
```
...
```bash
curl "http://127.0.0.1:23333/stock/daily?tickers=AAPL,MSFT&start=2025-01-06&end=2025-01-10"
```
...
```bash
curl http://127.0.0.1:23333/option
```
...
```bash
curl "http://127.0.0.1:23333/option/ticker_query?contract=O:NVDA250117C00136000&start=2025-01-06&end=2025-01-10&resolution=day"
```
...
```bash
curl "http://127.0.0.1:23333/option/ticker_query?contract=O:NVDA250117C00136000&start=2025-01-06T09:30:00&end=2025-01-06T16:00:00&resolution=minute"
```
...
```bash
curl "http://127.0.0.1:23333/option/chain_query?underlying=NVDA&date=2025-01-06&type=C&strike_min=130&strike_max=140&expiry_max=2025-02-21"
```
...
```bash
curl "http://127.0.0.1:23333/rates/query?start=2025-01-02&end=2025-01-10&tenors=1M,10Y"
```
